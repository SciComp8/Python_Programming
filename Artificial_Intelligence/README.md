...
- [Slice and index a dataframe](https://github.com/SciComp8/Python_Programming/blob/main/Utilities/pandas/*pandas_slice_index.py#L173)
  ...
  - [Create balanced folds in cross-validation for continuous target](https://github.com/SciComp8/Python_Programming/blob/main/Utilities/pandas/pandas_cut_rank.py), where each each bin/stratum includes a roughly equal number of samples 
